...
import { laneListSelector } from './laneList-selector';
//
...
//   const targetLane = targetId
//     ? laneList.find(lane => lane.notes.includes(targetId))
//     : null;
...
//     return yield put(
//       arrangeNote({ sourceNoteIndex, targetNoteIndex, laneId: sourceLaneId })
//     );
//   }
